            ...
            <el-col :span="12" class="eeg-col">
                <el-row class="eeg-row-1">
                    <div class="eeg-header-div">
                        <el-row class="eeg-header-row">
                            <!-- <el-col :span="10" class="eeg-icon-col">
                                <img src="@/assets/img/eeg/eeg-icon.png" class="eeg-icon-img"/>
                                <span class="eeg-icon-title">脑电数据</span>
                            </el-col>
                            <el-col :span="6" :offset="8" class="eeg-icon-col-2">
                                <span class="eeg-icon-title-2">流入数据量：x条/s</span>
                            </el-col> -->
                        </el-row>
                    </div>
                </el-row>
...
import ItemHeart2 from './ItemHeart2.vue'
...
export default {
    ...
    methods: {
        ...
        mqttMSG() {
            const mqtt_host = "ws://127.0.0.1:8083/mqtt";
