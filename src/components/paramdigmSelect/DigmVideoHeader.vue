    ...
    <div>
        <el-header class="header" width="100%" height="75px" style="background-color:#F0F2F5">
            <el-row style="vertical-align:middle">
                <el-col :span="4" style="margin-top: 20px"><b style="font-size: 20px;">{{$t("homepage.paradigm")}}</b></el-col>
                <el-col :span="13">
                    <el-button style="margin-top:3%;background-color:#0D1E41;color:white" @click="$router.push('/paramdigm')">{{$t("head_title.previous")}}</el-button>
                </el-col>
